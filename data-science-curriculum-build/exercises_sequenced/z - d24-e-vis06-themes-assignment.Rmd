...
-   It took away the grey background, text is larger, guide line are now grey
...
mpg %>%
  ...
  geom_point() +
  theme(
    line = element_line(size = 6, color = "pink"),
    rect = element_rect(fill = "purple"),
    axis.text.x = element_text(size = 24, angle = 15),
    axis.text.y = element_text(size = 6, angle = 96)
  )
```
