...
*Reading*: [Programming Basics](https://rstudio.cloud/learn/primers/1.2). *Topics*: `functions`, `arguments` *Reading Time*: \~ 10 minutes
...
sd = 0; vector of standard deviations
...
To list all available packages I type library() in the command line
