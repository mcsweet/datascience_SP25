...
### **q1** Load the `tidyverse` and inspect the `diamonds` dataset. What do the `cut`, `color`, and `clarity` variables mean?
...
-   Carat ranges from 0.2-5.01 with the mean at 0.7979. They tend be low
    in carrot as a general population
-   Price range is drastic from 326-18823.
-   While the ranges for min and max for x and y differ greatly (0-10.74
    vs 0-58.90) they have similar means of 5.731 and 5.735 respectfully.
    The z dimensions has a max of 31 but all quadrants are under 4.04.
-   Color, Cut, and Clarity do not follow the same increase in value
    patterns as their variables changes
