...
df_q2 <-
  ...
  mutate(
    ci_lwr = mean_price - 1.96 * sd_price / sqrt(n_price),
    ci_upr = mean_price + 1.96 * sd_price / sqrt(n_price),
    pi_lwr = mean_price - 1.96 * sd_price,
    pi_upr = mean_price + 1.96 * sd_price
  ) %>% 
