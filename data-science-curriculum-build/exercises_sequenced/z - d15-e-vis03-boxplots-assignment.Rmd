...
-   For carat 0 - 0.5 the median and the quantiles are extremely close
    in price. The whiskers are also short and thus show there is not
    much variation between 0-0.5 carat cuts and their price

-   From carat 0-2.5 the price tends to increased with carat median
    price. It is important to point out that there is high price
    variation in the data in most of those carat categories with long
    whiskers and outlier data.

-   From carar 2.5-5 there tends to be only a slight increase in median
    price.

Write your observations here! - Make sure to distinguish between the
trend in median (bar), quantiles (box edges), and whiskers (vertical
lines)
...
-   Yes the most common group is now premium with I color. It was G,
    Ideal
