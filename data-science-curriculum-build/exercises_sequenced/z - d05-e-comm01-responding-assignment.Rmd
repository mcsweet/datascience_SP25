...
-   Is the bolded response **active** or **passive**? Why?
    -   The presenter responds directly to the question and acknowledges what they asked
-   Is the bolded response **constructive** or **destructive**? Why?
    -   It is constructive as it gave them a chance to catch their mistake and point out what they did wrong. They then go and explain it without more apologies
...
-   Is the bolded response **active** or **passive**? Why?
    -   passive as it does not actually help answer the question
-   Is the bolded response **constructive** or **destructive**? Why?
    -   constructive as it acknowledges what was asked and explains why the error was made/
-   How does this statement make you *feel*, relative to the bolded statement before the q1 prompt?
    -   This is better than the first one as its more postive but its not helpful
...
-   Is the bolded response **active** or **passive**? Why?
    ...
    passive as its not about the content

-   Is the bolded response **constructive** or **destructive**? Why?

    its destructive because its not uplifting
