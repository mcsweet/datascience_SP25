...
-   Which rows did you pick?
    -   I included any rows that had normalized death and case number that were above or equal to 0
-   Why?
...
-   Loving has more cases than people which could be due to the state worker who logged the data inputting the wrong amount or a large number of people being treated in the county. The county only has a population of 102 persons.
